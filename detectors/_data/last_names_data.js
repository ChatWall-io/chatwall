...
const LAST_NAMES_LIST = [
    ...
    "Dupont", "Martin", "Bernard", "Petit", "Robert", "Richard", "Durand", "Dubois", "Moreau", "Laurent",
    "Wang", "Li", "Zhang", "Liu", "Chen", "Yang", "Huang", "Zhao", "Wu", "Zhou"
];

const lastnamesdataSet = new Set(LAST_NAMES_LIST.map(n => n.toLowerCase()));

if (typeof module !== 'undefined' && module.exports) {
    module.exports = { lastnamesdataSet };
} else {
    var globalScope = (typeof self !== 'undefined') ? self : window;
    globalScope.lastnamesdataSet = lastnamesdataSet;
}
